			...
			'general' => array(
				...
				'content_name_font_family'=>array(
					...
					'selector'=> array(
						'type'=>'font',
						'font'=>'{{ VALUE }}',
						'css'=>'.sppb-carousel-extended-person-name { font-family: "{{ VALUE }}"; }'
					),
					'depends'=>array(
						array('content_style', '=', 'name_style'),
						array('carousel_options', '=', 'item_style'),
				...
				'content_designation_font_family'=>array(
					...
					'selector'=> array(
						'type'=>'font',
						'font'=>'{{ VALUE }}',
						'css'=>'.sppb-carousel-extended-person-designation { font-family: "{{ VALUE }}"; }'
					),
					'depends'=>array(
						array('content_style', '=', 'designation_style'),
						array('carousel_options', '=', 'item_style'),
				...
				'sp_team_carousel_item'=>array(
					...
					'std'=> array(
						array(
							'team_carousel_img' => 'https://sppagebuilder.com/addons/team_carousel/team1.jpg',
						...
						array(
							'team_carousel_img' => 'https://sppagebuilder.com/addons/team_carousel/team2.jpg',
							'person_name' => 'Jhon Doe',
							'person_designation' => 'Software Engineer',
							'team_carousel_item' => array(
								array(
						...
						array(
							'team_carousel_img' => 'https://sppagebuilder.com/addons/team_carousel/team3.jpg',
							'person_name' => 'Jhon Doe',
							'person_designation' => 'Software Engineer',
							'team_carousel_item' => array(
								array(
